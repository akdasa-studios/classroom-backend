...
import { LessonsService } from '@classroom/backend/services'
import { CreateLessonRequest, CreateLessonResponse, GetLessonResponse, GetLessonsResponse, UpdateLessonRequest, UpdateLessonResponse } from '@classroom/backend/protocol'
