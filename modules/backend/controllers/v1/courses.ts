...
import { CoursesService } from '@classroom/backend/services'
import { CreateCourseRequest, CreateCourseResponse, GetCourseResponse, GetCoursesResponse, UpdateCourseRequest, UpdateCourseResponse } from '@classroom/backend/protocol'
