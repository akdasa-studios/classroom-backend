...
import { CreateGroupRequest, CreateGroupResponse, GetGroupResponse, GetGroupsResponse, UpdateGroupRequest, UpdateGroupResponse } from './groups.protocol'
import { ValidationError } from 'src/utils/entities.service'
